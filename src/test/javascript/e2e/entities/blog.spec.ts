...
describe('Blog e2e test', () => {
    ...
    it('should load Blogs', () => {
        ...
        expect(blogComponentsPage.getTitle()).toMatch(/jhipsterhelloworldApp.blog.home.title/);
    ...
    it('should load create Blog dialog', () => {
        ...
        expect(blogDialogPage.getModalTitle()).toMatch(/jhipsterhelloworldApp.blog.home.createOrEditLabel/);
