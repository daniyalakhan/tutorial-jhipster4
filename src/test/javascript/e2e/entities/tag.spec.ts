...
describe('Tag e2e test', () => {
    ...
    it('should load Tags', () => {
        ...
        expect(tagComponentsPage.getTitle()).toMatch(/jhipsterhelloworldApp.tag.home.title/);
    ...
    it('should load create Tag dialog', () => {
        ...
        expect(tagDialogPage.getModalTitle()).toMatch(/jhipsterhelloworldApp.tag.home.createOrEditLabel/);
        tagDialogPage.close();
    });
